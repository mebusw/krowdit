...
import com.tadosoft.krowdit.servlet.RecoverPassword;
...
public class TestRecoverPasswordServlet {
	...
	private static final Logger log = LoggerFactory
			.getLogger(TestRecoverPasswordServlet.class);

	@Autowired
	private TableUserDAO userDao;

	/** the Object Under Test */
	private RecoverPassword servlet;
	...
	public TestRecoverPasswordServlet() {
		servlet = new RecoverPassword();
	...
	public void setUp() throws Exception {
		...
		servlet.setEmailSendingQueue(EmailSendingQueue.getInstance());
	...
	public void testprocessBusiness_SUCCESS() {
		...
		assertEquals(1, servlet.getEmailSendingQueue().size());
